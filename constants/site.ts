...
export const BUILDERS: Builder[] = [
  ...
  },
  {
    ...
    projects: ["Brigade Manor", "Brigade Enclave", "Brigade Barcelona", "Brigade Gateway Residences, Neopolis", "Brigade Cornerstone Utopia", "Brigade Meadows", "Brigade Exotica"],
    established: "1986",
...
export const FEATURED_PROJECTS: FeaturedProject[] = [
  {
    ...
    configurations: "3 and 4 BHK · 2,067–3,164 sq. ft. super built-up area",
    highlights: [
      "4.79 acres with 190 residences in a low-density development",
      "G+5 floors with two basement parking levels",
      "Approx. 20,000 sq. ft. clubhouse",
    ],
    indicativeStartingPrice: "₹2.09 Cr onwards*",
    priceNote: "As shown in the supplied Brigade Manor price screenshot. Government charges, other charges and taxes are applicable; prices are subject to change.",
    detailsPage: "/projects/brigade-manor",
    coverImage: "/projects/brigade-manor-cover.jpg",
    masterLayout: "/projects/brigade-manor-masterplan.jpg",
    locationMap: "/projects/brigade-manor-location-map.jpg",
    sampleVideos: [{ label: "Brigade Manor project video", videoId: "J9sjxZUYVUQ" }],
    overview: "Brigade Manor is a low-rise residential community in Moti Nagar, Hyderabad. The supplied brochure describes spacious 3 and 4 bedroom homes, landscaped shared spaces and a clubhouse.",
    quickFacts: [
      { label: "Location", value: "Moti Nagar, Hyderabad" },
      { label: "Site area", value: "4.79 acres" },
      { label: "Residences", value: "190 homes" },
      { label: "Configurations", value: "3 and 4 BHK" },
      { label: "Super built-up", value: "2,067–3,164 sq. ft." },
      { label: "Carpet area", value: "1,296–1,933 sq. ft." },
      { label: "Structure", value: "G+5 floors · 2 basement levels" },
      { label: "Clubhouse", value: "Approx. 20,000 sq. ft." },
    ],
    amenityGroups: [
      { category: "Arrival, landscape and movement", amenities: ["01. Entry portal", "02. Security cabin", "03. Arrival court", "04. Clubhouse drop-off", "05. Bus waiting area", "06. Drop-off court", "08. Driveway", "09. Tower drop-off", "10. Jogging / pedestrian / bicycle track", "12. Terraced flower beds", "13. Stepped seating", "14. Walkway", "21. Plaza seating"] },
      { category: "Outdoor recreation and wellness", amenities: ["07. Practice cricket pitch", "11. Party lawn", "15. Yoga lawn", "16. Meditation pavilion", "17. Kids’ play area", "18. Outdoor gym", "19. Pickleball court", "20. Pavilion with seating", "22. Pet park", "23. Futsal / multi-play court"] },
      { category: "Clubhouse amenities", amenities: ["01. Entrance foyer / holding", "02. Multipurpose hall", "03. Pantry", "04. Grocery store", "05. Badminton hall", "06. Indoor games", "07. Gym", "08. Passage", "09. Deck", "10. Aerobics", "11. Deck area", "12. Store", "13. Pool services", "14. Spa", "15. Terrace", "16. Pool deck", "17. Swimming pool"] },
    ],
    nearbyPlaces: [
      { category: "Education", places: ["Sri Sadhana Academy · 350 m", "The Model City School · 500 m", "Gowtham Model School, Moti Nagar · 750 m", "NASH Academy (Meem Education Society) · 850 m", "Don Bosco High School · 300 m", "Hyderabad Public School · 6.6 km"] },
      { category: "Healthcare", places: ["Neelima Hospital · 400 m", "Sunridge Multi-Speciality Hospital · 700 m", "Jaiswal Multi Speciality Hospital · 1.1 km", "Shreya Hospital · 1.1 km", "Yasodha Hospital · 6 km"] },
      { category: "Shopping and leisure", places: ["Lake Shore Mall · 3.2 km", "Ashoka One Mall · 4.5 km", "Next Galleria Mall · 4.8 km"] },
    ],
    specifications: [
      { category: "Project overview", details: ["Low-density premium development across 4.79 acres", "190 residences", "G+5 floors with two levels of basement parking", "Approx. 20,000 sq. ft. clubhouse"] },
      { category: "Home sizes", details: ["3 and 4 BHK residences", "Super built-up area: 2,067–3,164 sq. ft.", "Unit carpet area: 1,296–1,933 sq. ft."] },
    ],
  },
  {
    ...
    builder: "Brigade Group",
    location: "Moti Nagar, Hyderabad",
    locationLink: "https://maps.app.goo.gl/FYjVrqN4kcEqU9vU6",
    configurations: "3 and 4 BHK spacious apartments · 1,868–2,632 sq. ft. super built-up area",
    highlights: [
      "4.5 acres with 215 homes in a low-rise community",
      "Walkable access to the Metro station, as stated in the brochure",
      "Starting price shared at ₹1.9 Cr onwards*",
    ],
    indicativeStartingPrice: "₹1.9 Cr onwards*",
    priceNote: "Starting price supplied for this listing. Confirm current unit pricing, government charges, taxes and availability with Brigade Group.",
    detailsPage: "/projects/brigade-enclave",
    coverImage: "/projects/brigade-enclave-cover.jpg",
    masterLayout: "/projects/brigade-enclave-masterplan.jpg",
    locationMap: "/projects/brigade-enclave-location-map.jpg",
    overview: "Brigade Enclave is a low-rise residential community in Moti Nagar, Hyderabad. The brochure describes a 4.5-acre development with 215 homes, shared landscaped spaces and 3 and 4 BHK apartments.",
    quickFacts: [
      { label: "Location", value: "Moti Nagar, Hyderabad" },
      { label: "Site area", value: "4.5 acres" },
      { label: "Homes", value: "215 residences" },
      { label: "Configurations", value: "3 and 4 BHK" },
      { label: "Super built-up", value: "1,868–2,632 sq. ft." },
      { label: "Carpet area", value: "1,162–1,612 sq. ft." },
      { label: "Starting price", value: "₹1.9 Cr onwards* per supplied brief" },
    ],
    amenityGroups: [
      { category: "Arrival, landscape and outdoor movement", amenities: ["01. Entry and exit", "02. Security cabin", "03. Pedestrian entry", "04. Drop-off / pickup point", "05. Waiting pavilion", "06. Connecting path", "07. Transformer yard", "08. Exit ramp from basement", "09. Entry ramp to basement", "10. Arrival plaza", "11. Lounge plaza", "18. Multipurpose spillover plaza"] },
      { category: "Sports, play and wellness", amenities: ["12. Pickleball court", "13. Play area – sandpit", "14. Play equipment", "15. Pool and deck", "16. Outdoor shower", "17. Party lawn", "19. Reflexology path", "20. Nature wellness plaza", "21. Pet park"] },
      { category: "Clubhouse facilities", amenities: ["01. Entrance lobby", "02. Multipurpose hall", "03. Pantry", "04. Grocery store", "05. Gym", "06. Kids’ play area", "07. Steam and sauna", "08. Badminton court", "09. Indoor games", "10. Aerobics", "11. Reading room / library / coworking", "12. Yoga / meditation deck"] },
    ],
    nearbyPlaces: [
      { category: "Education", places: ["Sri Sadhana Academy · 350 m", "Gowtham Model School, Moti Nagar · 750 m", "NASH Academy (Meem Education Society) · 850 m", "The Model City School · 500 m", "Don Bosco High School · 550 m", "Hyderabad Public School · 6.8 km"] },
      { category: "Healthcare", places: ["Revive Plus Multispeciality Hospital · 450 m", "Sunridge Multi-Speciality Hospital · 700 m", "Dr Naveen Reddy Hospital · 700 m", "Jaiswal Multi Speciality Hospital · 1.1 km", "Shreya Hospital · 1.1 km"] },
      { category: "Shopping and leisure", places: ["Brigade Citadel · 400 m", "Moti Nagar Shopping Complex · 600 m", "Krishna Murthy Govula · 2.2 km"] },
    ],
    specifications: [
      { category: "Project overview", details: ["4.5-acre residential development", "215 homes", "3 and 4 BHK apartments", "Walkable access to the Metro station, as described in the supplied brochure"] },
      { category: "Home sizes", details: ["Super built-up area: 1,868–2,632 sq. ft.", "Carpet area: 1,162–1,612 sq. ft."] },
    ],
  },
  {
    name: "Unnathi",
