...
import { FileCheck2, Landmark, ClipboardList, BadgeCheck } from "lucide-react";
    ...
    <>
      ...
      <section className="section-pad bg-offwhite">
        <div className="container-xl px-0">
          ...
          <StaggerContainer className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-5">
            {BANKS.map((bank) => (
